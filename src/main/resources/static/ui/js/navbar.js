		...
		$('#nav-bar-picture-icon').click(function(e) {  
		 ...
		 $('#notification-icon').click(function(e) {   
			 $('.display-options-box').hide(); 
			   ...
			   $('#notification-box-display').empty();
			   $('#notification-box-display').append("<li class='read-notification'>"+
				"<div style='display: flex;flex-direction:column;margin-left:5px;'><h5><b>View All Notification</b></h5></div>"+
			"</li>")
			   var xhr = new XMLHttpRequest();
			   xhr.onreadystatechange = function(){
				   if (xhr.readyState == 4 && xhr.status == 200){
					   ...
					   response.some(function(res){
						   $("#notification-box-display").prepend(add_notification(res));
					   })
				   }
			   }
