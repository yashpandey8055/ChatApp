...
public class NotificationCollectionDAOImpl implements IMongoCollection {
	...
	public List<? extends MongoDocument> findList(String key, Object value) {
		return template.find(Query.query(Criteria.where(key).is(value)), NotificationDocument.class);
	}
	...
	public DeleteResult delete(String key, Object value) {
		return template.remove(Query.query(Criteria.where(key).is(value)), NotificationDocument.class);
	}
