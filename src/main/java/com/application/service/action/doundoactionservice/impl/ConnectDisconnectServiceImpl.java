...
public class ConnectDisconnectServiceImpl implements IDoUndoAction{
	
	private MongoTemplate template;

	@Autowired
	public ConnectDisconnectServiceImpl(MongoTemplate template){
	...
	if(document==null) {
		document = new FollowDocument();
		document.setConnection(Arrays.asList(followedBy));
